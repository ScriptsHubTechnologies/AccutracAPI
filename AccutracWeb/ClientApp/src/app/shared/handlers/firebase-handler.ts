    ...
    static Parse(errorCode: string): string {
        ...
        switch (errorCode) {
            ...
            case 'auth/user-not-found':
                message =
                    'We could not find a user account associated with the email address provided.';
                break;
            case 'auth/phone-number-already-exists':
                message = 'The phone number you entered is already in use by an existing user.';
                break;
            case 'auth/invalid-phone-number':
                message = 'The phone number is not a valid phone number!';
                break;
            case 'auth/invalid-email':
                message = 'The email address provided is not a valid email address.';
                break;
